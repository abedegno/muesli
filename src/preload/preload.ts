...
const bridge: MuesliBridge = {
  ...
  addNoteLink: (id, toNoteId) => ipcRenderer.invoke(IPC.addNoteLink, id, toNoteId),
  listActionItems: (status?: string) => ipcRenderer.invoke(IPC.listActionItems, status),
  ...
  createShare: (noteId, options) => ipcRenderer.invoke(IPC.createShare, noteId, options),
  listNoteShares: (noteId) => ipcRenderer.invoke(IPC.listNoteShares, noteId),
  revokeShare: (token) => ipcRenderer.invoke(IPC.revokeShare, token),
  ...
  setFolderVisibility: (id, visibility) => ipcRenderer.invoke(IPC.setFolderVisibility, id, visibility),
  ...
  createTemplate: (name, phase, sections, autoRun) => ipcRenderer.invoke(IPC.createTemplate, name, phase, sections, autoRun),
  updateTemplate: (id, name, phase, sections, autoRun) => ipcRenderer.invoke(IPC.updateTemplate, id, name, phase, sections, autoRun),
  ...
  exportNote: (noteId, format, options) => ipcRenderer.invoke(IPC.exportNote, noteId, format, options),
  exportFolder: (folderId, format, options) => ipcRenderer.invoke(IPC.exportFolder, folderId, format, options),
  ...
  checkPluginHealth: (id) => ipcRenderer.invoke(IPC.checkPluginHealth, id),
  setStreamingTranscriber: (req) => ipcRenderer.invoke(IPC.setStreamingTranscriber, req),
  clearStreamingTranscriber: () => ipcRenderer.invoke(IPC.clearStreamingTranscriber),
  ...
  systemAudioStatus: () => ipcRenderer.invoke(IPC.systemAudioStatus),
  systemAudioRequest: () => ipcRenderer.invoke(IPC.systemAudioRequest),
