...
const tplA: Template = { id: 'tpl-a', name: 'Action items', sections: [], built_in: true }
const tplB: Template = { id: 'tpl-b', name: 'General meeting', sections: [], built_in: true }
const tplC: Template = { id: 'tpl-c', name: 'Retro', sections: [], built_in: false }
...
describe('NoteView — selection survives the async-template-list reorder race (TPL01)', () => {
  ...
  const tplUser: Template = { id: 'tpl-user', name: 'Zebra notes', sections: [], built_in: false }
  const tplBuiltin: Template = { id: 'tpl-builtin', name: 'general update', sections: [], built_in: true }
