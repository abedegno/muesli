...
export const MEETING_DETECTION_LOOP_INTERVAL_MS = 45_000
export const MEETING_DETECTION_WINDOW_BACK_MS = 2 * 60 * 60 * 1000
export const MEETING_DETECTION_WINDOW_FORWARD_MS = 30 * 60 * 1000
