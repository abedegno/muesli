...
app.whenReady().then(async () => {
  try {
    ...
    ipcMain.handle(IPC.createTemplate, (_e, name: string, phase: TemplatePhase, sections: TemplateSection[]) => handlers.createTemplate(name, phase, sections))
    ipcMain.handle(IPC.updateTemplate, (_e, id: string, name: string, phase: TemplatePhase, sections: TemplateSection[]) => handlers.updateTemplate(id, name, phase, sections))
