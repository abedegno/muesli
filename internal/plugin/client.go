...
// request. Mirrors pluginkit.GenerateSource -- see its doc comment.
...
// CalendarEventSource is the normalized calendar-event generation source.
// Mirrors pluginkit.CalendarEventSource.
